    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-3">
                    <h5>Edit account</h5>
                    <form method="GET" action="accountEdited.htm" class="form-signin">


                        <div class="form-group">

                            <label>Account number</label>
                            <input name="accNumber" type="text" class="form-control" value = "${account.accNumber}" autofocus="true"/>
                            <label>Account type</label>
                            <input name="type" type="text" class="form-control" value = "${account.type}" autofocus="true"/>
                            <label>Amount</label>
                            <input name="amount" type="text" class="form-control" value = "${account.amount}"/>
                            <br>
