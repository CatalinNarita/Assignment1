...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-3">
                    <h5>Generate report for ${name}</h5>
                    <form method="POST" action="generateReport.htm" class="form-signin">


                        <div class="form-group">
                            <label>Enter the report period below (yyyy-MM-dd)</label>
                            <br>
                            ...
                            <textarea name="content" type="text" class="form-control"autofocus="true"/></textarea>
                        </div>
                        <c:out value="${message}"/>
                        <button class="btn btn-lg btn-primary btn-block" type="submit">Submit report</button>
                    </form>
                </div>
            </div>
