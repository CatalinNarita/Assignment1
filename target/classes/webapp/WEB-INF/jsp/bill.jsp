                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <c:forEach items = "${billList}" var = "bill">
                            <tr>
                                <td><a href = "billForm.htm?billId=${bill.billId}&amount=${bill.amount}"><c:out value = "${bill.company}"></c:out></a></td>
                                <td><c:out value = "${bill.amount}"></c:out></td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
