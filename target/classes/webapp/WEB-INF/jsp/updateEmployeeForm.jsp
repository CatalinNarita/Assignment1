    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-3">
                    <h5>Update user</h5>
                    <form method="POST" action="updateEmployee.htm" class="form-signin">


                        <div class="form-group">
                            <label>Name</label>
                            <input name="name" type="text" class="form-control" value="${employee.name}" autofocus="true"/>
                            <label>Username</label>
                            <input name="username" type="text" value="${employee.username}" class="form-control"/>
                            <label>Password</label>
                            <input name="password" type="text" value="${employee.password}" class="form-control"/>

                        </div>
                        <c:out value="${message}"/>
                        <button class="btn btn-lg btn-primary btn-block" type="submit">Update Employee</button>
                    </form>
                </div>
            </div>
