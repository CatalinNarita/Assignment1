        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form id="ask" action="deleteEmployee.htm" method="POST">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <c:forEach items = "${employeeList}" var = "employee">
                                <tr>
                                    ...
                                    <td><input id="editButton" type="checkbox" name="checked" value="${employee.employeeId}"></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
            ...
            <div class="row">
                <div class="col-md-3">
                    <input class="btn btn-lg btn-primary btn-block" type="button" value="Delete selected employees" name="delete" onclick="alert('Are you sure?');">
                </div>
            </div>
