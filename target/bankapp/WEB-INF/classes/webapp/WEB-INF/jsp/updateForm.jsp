    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-3">
                    <h5>Update user</h5>
                    <form method="POST" action="updateUser.htm" class="form-signin">


                        <div class="form-group">
                            <label>Name</label>
                            <input name="name" type="text" class="form-control" value = "${client.name}" autofocus="true"/>
                            <label>IC number</label>
                            <input name="icNumber" type="text" class="form-control" value = "${client.icNumber}"/>
                            <label>CNP</label>
                            <input name="cnp" type="text" class="form-control" value = "${client.cnp}"/>
                            <label>Address</label>
