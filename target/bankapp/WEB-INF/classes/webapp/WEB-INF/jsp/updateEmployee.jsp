                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <c:forEach items = "${employeeList}" var = "employee">
                            <tr>
                                <td><a href = "updateEmployeeForm.htm?username=${employee.username}&password=${employee.password}&employeeId=${employee.employeeId}"><c:out value = "${employee.name}"></c:out></a></td>
